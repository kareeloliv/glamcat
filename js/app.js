(() => {
    ...
    (() => {
        ...
        document.querySelectorAll(".sub-menu-catalog");
        function documentActions(e) {
            ...
            if (targetElement.closest("[data-parent]")) {
                ...
                } else console.log("Нет такого поденю");
                e.preventDefault();
            }
        }
        ...
        let fields = document.querySelectorAll(".documents-registration__input");
        Array.prototype.forEach.call(fields, (function(input) {
            let label = input.nextElementSibling, labelVal = label.querySelector(".documents-registration__button").innerText;
            input.addEventListener("change", (function(e) {
                let countFiles = "";
                if (this.files && this.files.length >= 1) countFiles = this.files.length;
                if (countFiles) label.querySelector(".documents-registration__button").innerText = "Выбрано файлов: " + countFiles; else label.querySelector(".documents-registration__button").innerText = labelVal;
            }));
        }));
        window["FLS"] = true;
        isWebp();
